...
void set_bar(bar & bar, const std::string * name = &default_name, const double weight = 2.85, const int calories = 350);
...
void set_bar(bar& bar, const std::string * name, const double weight, const int calories) {
	bar.mark = *name;
	bar.weight = weight;
